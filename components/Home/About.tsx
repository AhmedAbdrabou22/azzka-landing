      ...
      <div className="max-w-5xl mx-auto px-5 relative">
        ...
        <div className="text-center space-y-8">
          ...
          <p className="text-xl md:text-1xl text-gray-600 leading-relaxed max-w-4xl mx-auto">
           هو الحل الرقمي الأحدث والأكثر تطوراً، صُمم خصيصاً ليكون الذراع التقني الذكي لمؤسستك. في إصداره الأول، يأتي "أذكى" ليغير مفاهيم الإدارة التقليدية، معتمداً على أحدث خوارزميات المعالجة وواجهات الاستخدام التي تجمع بين البساطة والقوة. إنه النظام الاذكى الذي يفكر معك، وينمو بنمو أعمالك.
