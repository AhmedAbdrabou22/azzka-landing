            ...
            <div className="max-w-7xl mx-auto px-5 relative">
                ...
                <div className="text-center mb-16 space-y-6">
                    ...
                    <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                        منذ انطلاقنا في عام منذ انطلاقنا في 7-7- 2007، أخذت ماستر فيجن للحلول المتكاملة على عاتقها قيادة قطاع التكنولوجيا في مصر وخاصةً التكنولوجيا في السياحة. <strong>"أذكى"</strong> ليس مجرد منتج جديد، بل هو تتويج لأكثر من 18 عاماً من الخبرة والنجاح والشراكة مع أكثر من 500 مؤسسة، والفهم العميق لاحتياجات السوق، والشغف بالتطوير المستمر. نحن لا نقدم برمجيات فحسب، بل نبني شراكات نجاح مستدامة.
                    </p>
                </div>
