...
const modules = [
    ...
    },
    {
        ...
        icon: FaPlane,
        description: "ادارة متكاملة لعمليات الحج والعمرة",
    ...
    
    {
        ...
        icon: FaWarehouse,
        description: `ادارة متكاملة للعملاء، تتبّع العملاء والفرص والمبيعات في مكان واحد، مع أدوات ذكية لتحسين التواصل وزيادة التحويلات.`,
        features: ["ادارة العملاء المحتملين والفعليين", "متابعة العملاء", "نقاط الولاء والمكافآت","تارجت المبيعات","احصائيات وتقارير","تحليل البيانات لاتخاذ قرارات"],
