        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-right space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed">
              عندما تجتمع الخبرة مع الابتكار، ينتج نظام أذكى الجيل القادم من
              الحلول الرقمية المتكاملة) أحدث إبداعات شركة ماستر فيجن للحلول
              المتكاملة. نضع بين أيديكم خلاصة ريادتنا التقنية منذ عام 2007.
            </p>
