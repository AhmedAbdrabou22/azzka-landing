...
const modules = [
  ...
  { name: "Tourism Operations", icon: FaPlane },
  { name: "Customer Management", icon: FaHandshake },
  { name: "Electronic Archive", icon: FaFolder },
  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-10 w-96 h-96 bg-[#fe6813] rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left space-y-8">
            <h1 className="text-2xl md:text-2xl lg:text-6xl font-bold text-white leading-tight">
              <span className="text-[#fe6813]">Azzka</span> Integrated System
              <span className="block text-[#fe6813] mt-3">
                The Smartest System for Tourism Companies Management
              </span>
            </h1>

            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed">
              "Azzka" System... A name that summarizes performance. When experience meets innovation, Azzka produces the next generation of integrated digital solutions - the latest creation from Master Vision for Integrated Solutions. We present to you the essence of our technical leadership since 2007.
            </p>
          ...
          <div className="relative h-[500px] lg:h-[600px] flex items-center justify-center relative">
            ...
            {/* Decorative Elements */}
            <div className="absolute -bottom-10 -left-10 w-72 h-72 bg-[#fe6813]/20 rounded-full filter blur-3xl"></div>
            <div className="absolute -top-10 -right-10 w-72 h-72 bg-purple-400/20 rounded-full filter blur-3xl"></div>
          </div>
        </div>
      </div>
    </div>
